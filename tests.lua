...
Tests.tests = {
    ...
    {'(has "'..RE.token..'" (first (keys (lusp))))', false},
    ...
    {'(first (map ? [2 3.14 4 "Lusp" 16 true]))', 'number'},
    ...
    -- input
    {'(def f "'.. Tests.tmpfile.. '") (writefile "Lusp" f) (readfile f)', 'Lusp', 'input'},
    ...
    {'("lusp" (-> "lusp"))', 'error', 'error'},
    {'(for ("var" [2 4]) (-> var))', 'error'},
    {'(def "var" 2) (-> var)', 'error'},
    {'(def "var1" "var2" (unpack ["lusp" "42"]))', 'error'},
    {'(def ("var") (-> false))','error'},
    {'("'..RE.tokenize('lusp')..'")', 'error'},
    {'('..RE.tokenize('lusp')..')', 'error'},
    {'(def -var  (- 1 -1))', 'error'},
    {'(def -var  -1)','error'},
    ...
    {'(eval "(def '..RE.tokenize('var')..' (-> "Lusp"))") (-> '..RE.tokenize('var')..')', 'error'},
